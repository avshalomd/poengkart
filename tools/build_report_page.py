...
DISPLAY = {
    ...
    '2': "<var>y<sub>it</sub></var>&#8201;|&#8201;<var>F<sub>it</sub></var> = 1 &nbsp;&sim;&nbsp; \U0001d4a9(<var>&mu;</var> + <var>&alpha;<sub>s[i]</sub></var> + <var>&beta;<sub>p[i]</sub></var> + <var>&gamma;<sub>a[i]</sub></var> + <var>u<sub>i</sub></var> + <var>w<sub>c[i],t</sub></var> + <var>&rho;<sub>r(i,t)</sub></var>,&nbsp;<var>&sigma;</var><sup>2</sup>)",
    '3': "logit&#8201;<var>P</var>(<var>F<sub>it</sub></var> = 1) = <var>&nu;</var> + <var>&alpha;&prime;<sub>s[i]</sub></var> + <var>&beta;&prime;<sub>p[i]</sub></var> + <var>&gamma;&prime;<sub>a[i]</sub></var> + <var>u&prime;<sub>i</sub></var> + <var>w&prime;<sub>c[i],t</sub></var> + <var>&rho;&prime;<sub>r(i,t)</sub></var>",
...
INLINE = [
    ...
    (r'\alpha_{s[i]}', '<var>&alpha;<sub>s[i]</sub></var>'),
    ...
    (r'm \pm 1.28\,s', '<var>m</var> &plusmn; 1.28&#8201;<var>s</var>'),
