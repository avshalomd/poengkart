...
describe('sitemap.xml', () => {
  it('lists the home, the report and every school, once each', async () => {
    ...
    expect(locs[0]).toBe('https://poengkart-no.vercel.app/');
    expect(locs[1]).toBe('https://poengkart-no.vercel.app/report');
    expect(locs).toContain('https://poengkart-no.vercel.app/akershus/asker');
