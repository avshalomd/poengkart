...
import * as listview from './listview'; import * as places from './places'; import * as calc from './calc'; import * as lang from './lang'; import * as boot from './boot';
...
export function exposeGlobals(): void {
  ...
  const mods = [i18n, helpers, chance, map, chrome, sidebar, router, chart, programs, feedback, tips, intro, prefs, search, searchov, locate, listview, places, calc, lang, boot];
